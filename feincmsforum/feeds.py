...
class LastPosts(ForumFeed):
    ...
    title_template = 'feincmsforum/feeds/posts_title.html'
    description_template = 'feincmsforum/feeds/posts_description.html'
...
class LastTopics(ForumFeed):
    ...
    title_template = 'feincmsforum/feeds/topics_title.html'
    description_template = 'feincmsforum/feeds/topics_description.html'
