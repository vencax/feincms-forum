...
@render_to('feincmsforum/moderate.html')
    ...
    if request.user.is_superuser or request.user in forum.moderators.all():
        ...
        if 'move_topics' in request.POST:
            return {
                ...
                'topic_ids': topic_ids,
                'exclude_forum': forum,
                'TEMPLATE': 'feincmsforum/move_topic.html'
            }
...
@render_to('feincmsforum/forum.html')
@paged('topics', forum_settings.FORUM_PAGE_SIZE)
...
@transaction.commit_on_success
@render_to('feincmsforum/topic.html')
...
@login_required
@transaction.commit_on_success
@render_to('feincmsforum/add_post.html')
...
@login_required
@transaction.commit_on_success
@render_to('feincmsforum/edit_post.html')
